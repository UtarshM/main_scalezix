          ...
          {processSteps.map((step, index) => (
            <article key={step.title} className="panel relative overflow-hidden p-6 md:p-7">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 text-lg font-semibold text-foreground">
                  0{index + 1}
                </div>
                <div>
