...
import { serviceCards } from "@/content/prd-site";
import { buildMetadata } from "@/lib/seo";

export const metadata: Metadata = buildMetadata({
  title: "Services | AI Automation, Software & Marketing | Scalezix",
  description:
    "Explore Scalezix services in AI automation, software development, AI agents, CRM integrations, chatbots, and digital marketing.",
  path: "/services",
  keywords: [
    ...
    <main className="section-shell py-20 md:py-24">
      <div className="max-w-4xl">
        ...
        <h1 className="mt-5 text-4xl font-semibold tracking-[-0.05em] text-white md:text-6xl">
          AI Services Built for Business Growth
        </h1>
        <p className="mt-5 max-w-3xl text-base leading-8 text-slate-300">
          We combine AI automation, software development, and digital marketing into one growth
      ...
      <div className="mt-12 grid gap-5 lg:grid-cols-2">
        {serviceCards.map((service) => (
          <div key={service.slug} className="mesh-card rounded-[1.8rem] p-6">
            ...
            <p className="mt-5 text-sm text-slate-400">Who it’s for: {service.audience}</p>
            <div className="mt-6">
