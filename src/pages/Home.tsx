      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-50 via-white to-purple-50 relative">
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Premium web development, AI solutions, and digital marketing services. 50+ successful projects with 98% client satisfaction.",
            potentialAction: {
              "@type": "SearchAction",
            ...
            <AnimatedSection animation="fadeInLeft">
              <div>
                ...
                <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 mb-6 sm:mb-8 leading-relaxed">
                  Elevate your digital presence with our expert web development,
                  AI solutions, and digital marketing services. Join 500+
                  satisfied clients who've achieved remarkable growth with our
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12 sm:mb-16">
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-8">
                <div className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl p-6 text-white">
                  <h3 className="text-2xl font-bold mb-3">1. Web & Growth</h3>
                  <ul className="space-y-2 text-blue-100">
                    <li>• Website Development (E-com, SaaS, custom apps)</li>
                    <li>
                      • Marketing Services (Performance Ads, SEO, Social Media)
                    </li>
                  </ul>
                </div>
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl p-6 text-white">
                  ...
                  <ul className="space-y-2 text-purple-100">
                    <li>• Model fine-tuning (LLMs, domain-specific)</li>
                    <li>• Deployment on AWS/GCP/Azure</li>
                    <li>• API integrations & workflow automation</li>
                    <li>
                      • AI Infrastructure management (monitoring + scaling)
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive technology solutions across web development and AI
              deployment
            </p>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Shopify and custom e-commerce platforms with payment integration",
                icon: "🛒",
              ...
              },
              {
                ...
                description:
                  "AWS cloud migration and infrastructure management solutions",
                icon: "☁️",
              ...
              },
              {
                title: "AI Consulting",
                description:
                  "Strategic AI consulting to identify opportunities and implementation",
                icon: "🧠",
              ...
              },
              {
                ...
                description:
                  "Custom AI solutions including chatbots and machine learning models",
                icon: "🤖",
