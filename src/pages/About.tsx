  ...
  const values = [
    {
      ...
      description:
        "We're committed to delivering exceptional results that drive your business forward and create lasting impact.",
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Our team of expert developers, designers, and digital
                strategists work collaboratively to bring your vision to life.
                We believe in building long-term partnerships with our clients,
                providing ongoing support and guidance as your business grows.
              </p>
              <Link
                to="/contact"
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            drive growth, enhance efficiency, and create meaningful digital
            experiences. We're committed to being your trusted partner in
