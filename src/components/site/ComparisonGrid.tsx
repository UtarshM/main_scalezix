  ...
  return (
    <div className="w-full max-w-6xl mx-auto flex flex-col gap-12 relative z-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Legacy/Stuck Column */}
        <div className="rounded-2xl border border-red-500/20 dark:border-red-500/30 bg-red-50/50 dark:bg-red-950/20 p-6 md:p-8 relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-3 border-b border-slate-200 dark:border-white/10 pb-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-mono uppercase tracking-wider text-red-500 dark:text-red-400 mt-0.5">
                  Fragmented & Manual
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 pt-4 border-t border-slate-200 dark:border-white/10 text-[10px] font-mono text-red-500 dark:text-red-400">
            Result: AI interest fails to yield real bottom-line gains.
          </div>
        </div>

        {/* Scalezix Column */}
        <div className="rounded-2xl border border-[#473BFD]/25 dark:border-white/15 bg-slate-50 dark:bg-card/40 p-6 md:p-8 relative overflow-hidden flex flex-col justify-between shadow-sm">
          ...
          <div className="mt-8 pt-4 border-t border-slate-200 dark:border-white/10 text-[10px] font-mono text-emerald-600 dark:text-emerald-400">
